...
// import { GoCalendar } from 'react-icons/io';
	...
	return (
		<div className='about' id='about'>
			<div className='about__left'>
				...
				<div className='about__left__desc'>
					<p>
				...
				<div className='about__right__grid__container'>
					<div className='about__right__grid__item'>
						...
						<div className='grid__item__text'>
							...
							<p>
								Finding more information about your business and make sure your
								project is a good fit for the services I provide.
							</p>
						</div>
					</div>
					<div className='about__right__grid__item'>
					...
					<div className='about__right__grid__item'>
						...
						<div className='grid__item__text'>
							<h3>Develop & Test</h3>
							<p>
								Building your design into a finessed website and thoroughly test
			...
			<div className='about__faqs'>
				<div className='about__faqs__title'>
					<h1>
						<BsFillPatchQuestionFill /> Frequently asked questions
					</h1>
				</div>
				<div className='about__faqs__grid__container'>
					<div className='about__faqs__grid__item'>
						<h3>How long will my website take to build?</h3>
						<p>
							This can vary based on the project requirements and your specific
							needs. With that said, I typically have a pretty fast turnaround
							for projects. An average project takes around 2-3 weeks.
						</p>
					</div>
					...
					<div className='about__faqs__grid__item'>
						...
						<p>
							...
							downpayment, and the remainder on the final review of the website
							before it is launched and the domain is pointed.
						</p>
					</div>
					<div className='about__faqs__grid__item'>
						<h3>Where should my website be hosted?</h3>
						<p>
							This can vary depending on your needs, but for a majority of small
							businesses, you can get a reliable shared server with low latency
							for around $5-$10/month.
						</p>
					</div>
					<div className='about__faqs__grid__item'>
						<h3>Can I update the website myself?</h3>
						<p>
							Absolutely. You&apos;ll have access to the backend of the website
							where you can log in and make changes yourself. I am also happy to
							make content updates for you as part of the maintenance plan.
						</p>
					</div>
					<div className='about__faqs__grid__item'>
						...
						<p>
							...
							4years. All my websites are thoroughly tested on the latest mobile
					...
					<div className='about__faqs__grid__item'>
						...
						<p>
							Website design is a collaborative process, and I will ask for your
							ideas, feedback, and approval throughout all stages of the
							project. Some clients do not have a preference or would prefer me
							to have complete creative direction with their project, which I am
							more than happy to do. In these cases, I dive in and research your
							niche to create your design.
						</p>
					</div>
					<div className='about__faqs__grid__item'>
						...
						<p>
							...
							is taking that content and weaving it perfectly into your website.
							However, if you need content provided for your site, let me know
					...
					<div className='about__faqs__grid__item'>
						...
						<p>
							I design my sites with focus on legevity and flexibility, with the
							ability to expand, update and scale your website as your business
							grows and changes. The typical industry standard is to update your
							website every 2-4 years, but I am happy to partner with my clients
							to create long-lasting sites that are easy to refresh.
						</p>
					</div>
				</div>
			</div>
